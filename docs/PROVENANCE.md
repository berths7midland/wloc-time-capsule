...
The expanded upstream tree is stored at:

```text
upstream/wloc-eec07a8dc8de6dbaee8eac1fb376e4d03020154a/
```

## Local Changes

Published files in `modules/`, `dist/`, `worker/`, and `wloc.jpg` were copied from the frozen upstream commit.
